...
export default function Home() {
  ...
  return <main>
    <header className="topbar"><div className="brand"><span className="brandMark">F</span><span>FacelessLive</span></div><div className="headerActions"><span className="saveMessage">{message}</span><a className="ghostButton compact headerLink" href="/commerce">Travel Commerce</a><button className="ghostButton compact" onClick={saveDraft}><Save size={16}/> Save Draft</button><span className="buildBadge">STREAM STUDIO</span></div></header>
